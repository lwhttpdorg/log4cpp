...
- [3. Class Design](#3-class-design)
  ...
  - [3.2. Core Classes](#32-core-classes)
    - [3.2.1. Logger Interface (`logger`)](#321-logger-interface-logger)
    - [3.2.2. Logger Proxy (`logger_proxy`)](#322-logger-proxy-loggerproxy)
    - [3.2.3. Real Logger (`real_logger`)](#323-real-logger-reallogger)
