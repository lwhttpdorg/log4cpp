...
- [3. Class Design](#3-class-design)
  ...
  - [3.2. Core Classes](#32-core-classes)
    ...
    - [3.2.2. Logger Proxy (`logger_proxy`)](#322-logger-proxy-logger_proxy)
    - [3.2.3. Real Logger (`real_logger`)](#323-real-logger-real_logger)
...
- [6. Pattern Engine](#6-pattern-engine)
  - [6.1. Instance-Based Design](#61-instancebased-design)
...
- [8. Hot Configuration Reload](#8-hot-configuration-reload)
  - [8.1. Key Mechanism: Proxy Pattern](#81-key-mechanism-proxy-pattern)
